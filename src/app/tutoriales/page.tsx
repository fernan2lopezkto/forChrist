  ...
  return (
    <div>
      <div className="mx-5 pb-10">
        <h1 className="mt-15 text-5xl font-bold text-center">
          Tutoriales
        </h1>
        <h2 className="mb-5 text-3xlfont-bolt text-center">y herramientas</h2>
        {/* Card 1 */}
        <div className="card bg-base-100 image-full w-full sm:w-96 shadow-xl transform hover:scale-105 transition-transform duration-300">
          ...
          <div className="card-body">
            ...
            <p>
              Este video es una pequeña demostración de cómo se podría tocar la
              canción Ven Espíritu Santo de Barak
            </p>
            <div className="card-actions justify-end mt-auto">
              <Link
                href="/tutoriales/venespiritusanto"
