...
export default function VenEspirituSanto() {
  ...
  const guitarraVideoUrl = "https://www.youtube.com/watch?v=aSfTqN1c_z8";
  const bajoVideoUrl = "https://www.youtube.com/watch?v=5dNZ4iv36_Q&t=11s";
  const arreglo1PianoVideoUrl = "https://www.youtube.com/watch?v=JfQRXy0O5xw";
  const description =
    'En este video, aprenderás a tocar "Ven Espíritu Santo" de Barak. Te guiaremos paso a paso con la pista y los tutoriales necesarios para que puedas dominar esta hermosa canción. ¡Esperamos que te sea de gran bendición!';
  const verso =
        ...
        <div className="md:flex md:gap-8 items-start">
          ...
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <div className="collapse collapse-arrow bg-base-100 border border-base-300">
              ...
              <div className="collapse-title font-semibold">
                Tutorial de Ven Espíritu Santo en guitarra
              </div>
              <div className="collapse-content text-sm">
                <VideoPlayer
            ...
            <div className="collapse collapse-arrow bg-base-100 border border-base-300">
              <input type="radio" name="my-accordion-2" />
              <div className="collapse-title font-semibold">
                Tutorial de Ven Espíritu Santo en Bajo
              </div>
              <div className="collapse-content text-sm">
                <VideoPlayer
                  videoUrl={bajoVideoUrl}
                  title="Tutorial de Ven Espíritu Santo en guitarra"
                />
              </div>
            </div>
            ...
            <div className="collapse collapse-arrow bg-base-100 border border-base-300">
              ...
              <div className="collapse-content text-sm">
                <VideoPlayer
                  videoUrl={arreglo1PianoVideoUrl}
                  title="Tutorial de Ven Espíritu Santo en guitarra"
                />
              </div>
            </div>
